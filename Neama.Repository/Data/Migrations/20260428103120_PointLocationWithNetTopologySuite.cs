...
{
    /// <inheritdoc />
    public partial class PointLocationWithNetTopologySuite : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MealsSaved = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    SavedMoney = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Charity_AspNetUsers_ManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    WalledBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    Is_Active = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    ...
                    CreationDate = table.Column<DateOnly>(type: "date", nullable: false, defaultValueSql: "GETDATE()"),
                    ManagerId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    MainSectionId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Partner", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Partner_AspNetUsers_ManagerId",
                        column: x => x.ManagerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Partner_MainSection_MainSectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Is_Active = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    AverageRating = table.Column<decimal>(type: "decimal(18,1)", nullable: false, defaultValue: 0m),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Branch_Partner_PartnerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Partner_MainSectionId",
                table: "Partner",
                column: "MainSectionId");

            migrationBuilder.CreateIndex(
                name: "IX_Partner_ManagerId",
                table: "Partner",
                column: "ManagerId",
                unique: true,
                filter: "[ManagerId] IS NOT NULL");
